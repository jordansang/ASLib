...
void test_math()
{
    ...
    asl_print_dbg("Generate %d no duplicated item consume %lu seconds", TEST_RAND_MAX, end - start);
    ...
    asl_print_dbg("Generate %d item consume %lu seconds", TEST_RAND_MAX, end - start);
